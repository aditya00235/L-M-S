...
public class AddStudent extends JFrame implements ActionListener{
	...
	comboBox.setModel(new DefaultComboBoxModel(new String[] { "Mechanical", "CSE", "IT", "Civil", "Automobile", "EEE", "Other","ECE","Production" }));
	...
	comboBox_2.setModel(
			new DefaultComboBoxModel(new String[] { "1st", "2nd", "3rd", "4th", "5th", "6th", "7th", "8th" ,"9th","10th"}));
	...
	comboBox_3.setModel(new DefaultComboBoxModel(
			new String[] { "B.E", "B.Tech","B.Tech+M.tech Dual degree", "M.Tech", "MBA", "BBA", "BCA", "B.Sc", "M.Sc", "B.Com", "M.Com" }));
